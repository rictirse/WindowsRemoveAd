...
using WindowsRemoveAd.Control;

namespace WindowsRemoveAd;
...
public partial class MainWindow : Window
{
    ...
    public readonly VersionControl VersionControl;
    ...
    public MainWindow()
    {
        ...
        InitializeComponent();
        InitializeKeys();
        this.DataContext = VersionControl;
    ...
    private static bool CreateKey(string loc, string key)
    {
        ...
        if (keyRef is null)
        {
            MessageBox.Show("Failed to create a registry subkey during initialization!", "WindowsRemoveAd: Fatal Error", MessageBoxButton.OK, MessageBoxImage.Error);
            throw new InvalidOperationException("WindowsRemoveAd: Failed to create subkey during initialization!");
        }
